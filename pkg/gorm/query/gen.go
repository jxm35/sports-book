...
func Use(db *gorm.DB, opts ...gen.DOOption) *Query {
	return &Query{
		...
		Prediction:  newPrediction(db, opts...),
...
func (q *Query) clone(db *gorm.DB) *Query {
	return &Query{
		...
		Prediction:  q.Prediction.clone(db),
...
func (q *Query) ReplaceDB(db *gorm.DB) *Query {
	return &Query{
		...
		Prediction:  q.Prediction.replaceDB(db),
...
func (q *Query) WithContext(ctx context.Context) *queryCtx {
	return &queryCtx{
		...
		Prediction:  q.Prediction.WithContext(ctx),
