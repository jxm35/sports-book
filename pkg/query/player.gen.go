...
func newPlayer(db *gorm.DB, opts ...gen.DOOption) player {
	...
	_player.ID = field.NewInt32(tableName, "id")
	_player.Name = field.NewString(tableName, "name")
	_player.Position = field.NewString(tableName, "position")
	_player.UsID = field.NewInt32(tableName, "us_id")
...
func (p *player) updateTableName(table string) *player {
	...
	p.UsID = field.NewInt32(table, "us_id")
...
func (p playerDo) Exists(subquery interface{ UnderlyingDB() *gorm.DB }) IPlayerDo {
