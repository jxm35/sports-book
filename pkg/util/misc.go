...
func GetFixtures(season int32, league string) []model2.Match {
	var fixtureList []model2.Match
	m := query.Match
	c := query.Competition
...
func GetTeam(teamName string) model2.Team {
	t := query.Team
...
func GetTeamHomeMatchesBefore(team int32, since time.Time) ([]model2.Match, error) {
	ctx := context.Background()
	var res []model2.Match
	m := query.Match
	err := m.WithContext(ctx).
		Select(m.ALL).
		Where(
...
func GetTeamAwayMatchesBefore(team int32, since time.Time) ([]model2.Match, error) {
	ctx := context.Background()
	var res []model2.Match
	m := query.Match
	err := m.WithContext(ctx).
...
func GetTeamHomeMatchesSince(team int32, since time.Time) ([]model2.Match, error) {
	ctx := context.Background()
	var res []model2.Match
	m := query.Match
	err := m.WithContext(ctx).
...
func GetTeamAwayMatchesSince(team int32, since time.Time) ([]model2.Match, error) {
	ctx := context.Background()
	var res []model2.Match
	m := query.Match
	err := m.WithContext(ctx).
...
func GetMatchesInSeason(season int32) ([]model2.Match, error) {
	m := query.Match
	c := query.Competition
	ctx := context.Background()
	var res []model2.Match
...
func GetHomeLastXGames(team, season int32, date time.Time, numGames int) ([]model2.Match, error) {
	ctx := context.Background()
	m := query.Match
	c := query.Competition
...
func GetAwayLastXGames(team, season int32, date time.Time, numGames int) ([]model2.Match, error) {
	ctx := context.Background()
	m := query.Match
	c := query.Competition
...
func GetLastXGames(team, season int32, date time.Time, numGames int) ([]model2.Match, error) {
	ctx := context.Background()
	m := query.Match
	c := query.Competition
...
type LineupRes struct {
	...
	Appearance model2.Appearance
}

func GetLineup(team string, day time.Time) []model2.Player {
	p := query.Player
	a := query.Appearance
	t := query.Team
	m := query.Match

	var lRes []model2.Player
